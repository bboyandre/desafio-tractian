                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-between">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="#">Conheça o Produto</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#">Sobre Nós</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#">Materiais Gratuitos</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn" href="#">PT</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-sucess" href="#">Demonstração</a>
                            </li>
